export default {
  ...
  paymentIntentDescription:
    "Your consultation is booked for {consultationDate} at {consultationTime}. You can change the date and time when you want until 24 hours before the consultation.RU",
  payment_intents_not_found_error: "Payment intents not found",
  payment_description: "Consultation with {1} on {2}, {3} RU",
